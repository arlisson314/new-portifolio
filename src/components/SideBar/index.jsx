  ...
  return (
    <nav className="w-full h-full flex flex-col justify-center items-end z-40 bg-white fixed left-0 top-0 animate-showSidebar">
      ...
      <div className="w-full h-full flex flex-col space-y-12 mt-16 items-center">
        <NavItems Icon={FaHome} renderSiderbar={renderSiderbar}>Home</NavItems>
        <NavItems Icon={FaUserAlt} renderSiderbar={renderSiderbar}>About</NavItems>
        <NavItems Icon={FaIdCardAlt} renderSiderbar={renderSiderbar}>Projects</NavItems>
        <NavItems Icon={FaEnvelope} renderSiderbar={renderSiderbar}>Contact</NavItems>
      </div>
    </nav>
  );
}
