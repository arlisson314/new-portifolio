...
export default function About() {
  return (
    <div id="Sobre" className="w-full h-[calc(100vh_-_64px)] mt-20 flex flex-col items-ceter sm:flex-row sm:items-center sm:justify-center sm:space-x-20 sm:mt-0 sm:pb-20">
